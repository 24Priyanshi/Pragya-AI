...
export const protocolRows: readonly ProtocolRow[] = [
  ...
  },
  {
    ...
    imageCellBg: "bg-surface-container-low",
    body: [
      { text: "DENSEWALK", em: true },
      { text: " is our " },
      { text: "data-and-benchmark pipeline", em: true },
      ...
      { text: ". We then pair these motion-grounded actions with language supervision and evaluate in a dense benchmark spanning " },
      { text: "bottlenecks, crossings, occlusion, temporary gap openings, and dynamically narrowing free space", em: true },
      { text: " with metrics for safety, stability, and social compliance." },
    ],
  },
  {
